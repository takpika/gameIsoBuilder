...
class LinuxWineIsoBuilder:
    ...
    def buildRootFS(self):
        ...
        self.runCmd('apt install -y wine32 --no-install-recommends --no-install-suggests')
    ...
    def buildISO(self):
        ...
        self.runLocalCmd(f'cd isoroot && mkisofs -o {self.output} -R -J -T -V linux -b isolinux/isolinux.bin -no-emul-boot -boot-load-size 4 -boot-info-table .')

...
class LinuxBuilder:
    ...
    def buildISO(self):
        ...
        self.runLocalCmd('mount -o loop .tmp/efiboot.img .tmp/efiboot && mkdir -p .tmp/efiboot/EFI/syslinux')
        self.runLocalCmd('cp syslinux-6.03/efi64/efi/syslinux.efi .tmp/efiboot/EFI/syslinux/syslinux.efi')

...
class LinuxBuilder:
    ...
    def buildISO(self):
        ...
        self.runLocalCmd('mount -o loop .tmp/efiboot.img .tmp/efiboot && mkdir -p .tmp/efiboot/EFI/BOOT .tmp/isoroot/boot/grub')
        ...
        self.copyConfig('.tmp/isoroot/boot/grub/grub.cfg', {"{{CDLABEL}}": self.name, "{{CMDLINE}}": kernelCmdline})
